import { COMPANY_INFO, NAV_LINKS, SERVICES } from '../../data/content';
import './Footer.css';
      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div>
            ...
            <div className="footer__links">
              <span className="footer__link">{COMPANY_INFO.email}</span>
              <span className="footer__link">{COMPANY_INFO.phone}</span>
              <span className="footer__link">{COMPANY_INFO.location}</span>
            </div>
          </div>
        </div>
